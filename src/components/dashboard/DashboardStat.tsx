...
const DashboardStat: React.FC = () => {
  ...
  const getStatsForRole = (role: string | null) => {
    switch(role) {
      ...
      case 'admin':
        return [
          { title: 'Total Users', value: '856', icon: Users, trend: '+8% from last month', trendDirection: 'up' as const, color: 'blue' as const },
          { title: 'Managed Estates', value: '12', icon: Building, trend: '+1 new estate', trendDirection: 'up' as const, color: 'green' as const },
          { title: 'Monthly Revenue', value: '₦1.2M', icon: CreditCard, trend: '+5% from last month', trendDirection: 'up' as const, color: 'purple' as const },
          { title: 'Pending Approvals', value: '15', icon: Clock, trend: '8 processed today', trendDirection: 'down' as const, color: 'yellow' as const },
        ];
